...
// Task-7(animation).cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTask7animationApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CTask7animationApp

CTask7animationApp::CTask7animationApp()
{
...
// Единственный объект CTask7animationApp

CTask7animationApp theApp;


// Инициализация CTask7animationApp

BOOL CTask7animationApp::InitInstance()
{
